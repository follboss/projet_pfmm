...
public class Modele extends Observable implements Observer {
	...
	public void update(Observable o, Object arg) {
				// allumage et instinction du frigo en fonction de l'atteinte de la consigne ou de l'atteinte du point de ros�
	...
	// si le point de ros�e est atteint (temperature trop grande
	...
	// Si la temperature d�passe le seuille en moins ou en plus -> true
